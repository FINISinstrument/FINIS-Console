/*
 *
 *	xclibsc.h	External	01-Nov-2017
 *
 ...
 * Image read/write
 */
_cDcl(_dllpxlib,_cfunfcc,int)		pxd_readuchar  (int unitmap,pxbuffer_t framebuf,pxcoord_t ulx,pxcoord_t uly,pxcoord_t lrx,pxcoord_t lry,uchar  *membuf,size_t cnt,const char *colorspace);
_cDcl(_dllpxlib,_cfunfcc,int)		pxd_writeuchar (int unitmap,pxbuffer_t framebuf,pxcoord_t ulx,pxcoord_t uly,pxcoord_t lrx,pxcoord_t lry,uchar  *membuf,size_t cnt,const char *colorspace);
_cDcl(_dllpxlib,_cfunfcc,int)		pxd_readushort (int unitmap,pxbuffer_t framebuf,pxcoord_t ulx,pxcoord_t uly,pxcoord_t lrx,pxcoord_t lry,ushort *membuf,size_t cnt,const char *colorspace);
_cDcl(_dllpxlib,_cfunfcc,int)		pxd_writeushort(int unitmap,pxbuffer_t framebuf,pxcoord_t ulx,pxcoord_t uly,pxcoord_t lrx,pxcoord_t lry,ushort *membuf,size_t cnt,const char *colorspace);
_cDcl(_dllpxlib,_cfunfcc, pximage_s*)	pxd_defineImage   (int unitmap,pxbuffer_t framebuf,pxcoord_t ulx,pxcoord_t uly,pxcoord_t lrx,pxcoord_t lry,const char *colorspace);
_cDcl(_dllpxlib,_cfunfcc,pximage3_s*)	pxd_defineImage3  (int unitmap,pxbuffer_t startbuf,pxbuffer_t endbuf,pxcoord_t ulx,pxcoord_t uly,pxcoord_t lrx,pxcoord_t lry,const char *colorspace);
_cDcl(_dllpxlib,_cfunfcc,pximage_s*)	pxd_definePximage (int unitmap,pxbuffer_t framebuf,pxcoord_t ulx,pxcoord_t uly,pxcoord_t lrx,pxcoord_t lry,const char *colorspace);
_cDcl(_dllpxlib,_cfunfcc,pximage3_s*)	pxd_definePximage3(int unitmap,pxbuffer_t startbuf,pxbuffer_t endbuf,pxcoord_t ulx,pxcoord_t uly,pxcoord_t lrx,pxcoord_t lry,const char *colorspace);
...
_cDcl(_dllpxlib,_cfunfcc,int)		pxe_readuchar  (pxdstate_s*,int unitmap,pxbuffer_t framebuf,pxcoord_t ulx,pxcoord_t uly,pxcoord_t lrx,pxcoord_t lry,uchar  *membuf,size_t cnt,const char *colorspace);
_cDcl(_dllpxlib,_cfunfcc,int)		pxe_writeuchar (pxdstate_s*,int unitmap,pxbuffer_t framebuf,pxcoord_t ulx,pxcoord_t uly,pxcoord_t lrx,pxcoord_t lry,uchar  *membuf,size_t cnt,const char *colorspace);
_cDcl(_dllpxlib,_cfunfcc,int)		pxe_readushort (pxdstate_s*,int unitmap,pxbuffer_t framebuf,pxcoord_t ulx,pxcoord_t uly,pxcoord_t lrx,pxcoord_t lry,ushort *membuf,size_t cnt,const char *colorspace);
_cDcl(_dllpxlib,_cfunfcc,int)		pxe_writeushort(pxdstate_s*,int unitmap,pxbuffer_t framebuf,pxcoord_t ulx,pxcoord_t uly,pxcoord_t lrx,pxcoord_t lry,ushort *membuf,size_t cnt,const char *colorspace);
_cDcl(_dllpxlib,_cfunfcc,pximage_s*)	pxe_defineImage   (pxdstate_s*,int unitmap,pxbuffer_t framebuf,pxcoord_t ulx,pxcoord_t uly,pxcoord_t lrx,pxcoord_t lry,const char *colorspace);
_cDcl(_dllpxlib,_cfunfcc,pximage3_s*)	pxe_defineImage3  (pxdstate_s*,int unitmap,pxbuffer_t startbuf,pxbuffer_t endbuf,pxcoord_t ulx,pxcoord_t uly,pxcoord_t lrx,pxcoord_t lry,const char *colorspace);
_cDcl(_dllpxlib,_cfunfcc,pximage_s*)	pxe_definePximage (pxdstate_s*,int unitmap,pxbuffer_t framebuf,pxcoord_t ulx,pxcoord_t uly,pxcoord_t lrx,pxcoord_t lry,const char *colorspace);
_cDcl(_dllpxlib,_cfunfcc,pximage3_s*)	pxe_definePximage3(pxdstate_s*,int unitmap,pxbuffer_t startbuf,pxbuffer_t endbuf,pxcoord_t ulx,pxcoord_t uly,pxcoord_t lrx,pxcoord_t lry,const char *colorspace);
...
_cDcl(_dllpxlib,_cfunfcc,int)		pxd_quSnap(int unitmap, pxbuffer_t buffer);
...
_cDcl(_dllpxlib,_cfunfcc,int)		pxd_quLive(int unitmap, pxbuffer_t buffer, int rsvd);
...
_cDcl(_dllpxlib,_cfunfcc,int)		pxe_quSnap(pxdstate_s*,int unitmap, pxbuffer_t buffer);
...
_cDcl(_dllpxlib,_cfunfcc,int)		pxe_quLive(pxdstate_s*,int unitmap, pxbuffer_t buffer, int rsvd);
...
_cDcl(_dllpxlib,_cfunfcc,int)	  pxd_SILICONVIDEO_exportSettings(int unitmap,int rsvd,const char *pathname);
_cDcl(_dllpxlib,_cfunfcc,int)	  pxd_SILICONVIDEO_importSettings(int unitmap,int rsvd,const char *pathname);
...
_cDcl(_dllpxlib,_cfunfcc,int)	  pxe_SILICONVIDEO_exportSettings(pxdstate_s*,int unitmap,int rsvd,const char *pathname);
_cDcl(_dllpxlib,_cfunfcc,int)	  pxe_SILICONVIDEO_importSettings(pxdstate_s*,int unitmap,int rsvd,const char *pathname);
...
#define SILICONVIDEO_1514CL   1514
