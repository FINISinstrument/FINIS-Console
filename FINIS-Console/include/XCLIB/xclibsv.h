/*
 *
 *	xclibsv.h	External	01-Jan-2018
 *
 *	Copyright (C)  1999-2018  EPIX, Inc.  All rights reserved.
 *
...
#define PIXCI_EL1V7G	0x0047	/* version 7 supports gen2 x1		*/
#define PIXCI_EL1DBV7G	0x0048	/* version 7 supports gen2 x1		*/
...
struct xcdevparms {
    ...
    uint16  rsvd16[31];
    uint16  captqueuesize;	/* -CQ: size of capture enqueue/dequeue 		*/
    uint8   rsvd8[29];
    uint8   serialoptions;
